...
impl Verifier {
    ...
    pub fn verifyingKey() -> Result<VerifyingKey, Vec<u8>> {
        ...
        let delta2 = G2Point {
            X: [
                U256::from_be_bytes([45, 160, 168, 242, 218, 168, 73, 106, 143, 63, 204, 39, 190, 58, 111, 149, 208, 253, 25, 76, 16, 76, 194, 86, 26, 233, 69, 185, 239, 98, 178, 21]),
                U256::from_be_bytes([46, 118, 143, 187, 74, 121, 204, 102, 124, 36, 145, 59, 142, 166, 19, 9, 73, 250, 238, 27, 78, 249, 228, 146, 221, 8, 58, 112, 90, 126, 202, 227]),
            ],
            Y: [
                U256::from_be_bytes([16, 40, 187, 56, 229, 15, 36, 86, 119, 153, 60, 217, 68, 179, 255, 116, 175, 123, 249, 247, 82, 124, 238, 142, 96, 76, 98, 32, 168, 72, 197, 190]),
                U256::from_be_bytes([43, 73, 47, 201, 72, 154, 201, 214, 4, 31, 56, 54, 186, 249, 58, 16, 159, 146, 83, 82, 157, 128, 18, 224, 28, 224, 17, 195, 22, 200, 59, 230]),
            ],
        };

        let ic = [
            G1Point {
                X: U256::from_be_bytes([10, 41, 10, 55, 228, 68, 149, 248, 186, 111, 121, 183, 144, 162, 98, 167, 49, 48, 165, 90, 34, 142, 40, 142, 241, 141, 78, 163, 34, 190, 87, 187]),
                Y: U256::from_be_bytes([30, 4, 201, 134, 89, 159, 197, 194, 126, 250, 30, 150, 51, 91, 20, 44, 154, 247, 198, 101, 219, 140, 194, 190, 236, 45, 244, 106, 65, 58, 141, 15]),
            },
            G1Point {
                X: U256::from_be_bytes([42, 72, 200, 4, 252, 10, 89, 133, 48, 243, 104, 206, 195, 142, 79, 250, 28, 40, 234, 73, 60, 89, 116, 121, 92, 183, 83, 117, 44, 220, 241, 21]),
                Y: U256::from_be_bytes([1, 10, 74, 111, 126, 171, 165, 235, 4, 79, 202, 80, 231, 192, 191, 20, 24, 85, 253, 199, 153, 187, 168, 223, 134, 19, 251, 251, 143, 180, 246, 202]),
            },
            G1Point {
                X: U256::from_be_bytes([21, 169, 212, 69, 42, 151, 73, 208, 140, 241, 88, 134, 255, 61, 189, 182, 213, 36, 28, 178, 187, 51, 5, 248, 53, 145, 97, 101, 62, 155, 215, 179]),
                Y: U256::from_be_bytes([34, 50, 126, 116, 169, 97, 74, 225, 39, 22, 135, 72, 207, 59, 231, 228, 177, 185, 126, 149, 182, 33, 0, 204, 97, 77, 227, 64, 188, 155, 131, 131]),
            },
            G1Point {
                X: U256::from_be_bytes([10, 87, 146, 185, 89, 30, 198, 197, 143, 226, 46, 13, 228, 124, 157, 90, 80, 165, 19, 5, 195, 22, 205, 83, 206, 93, 44, 250, 253, 73, 154, 70]),
                Y: U256::from_be_bytes([47, 87, 198, 127, 73, 199, 49, 132, 47, 103, 103, 73, 230, 134, 224, 246, 90, 57, 124, 207, 10, 201, 141, 206, 221, 190, 42, 221, 230, 128, 139, 1]),
            },
            G1Point {
                X: U256::from_be_bytes([38, 245, 245, 240, 206, 161, 93, 215, 183, 147, 16, 9, 94, 96, 82, 182, 46, 238, 43, 91, 252, 45, 33, 37, 128, 40, 1, 223, 23, 189, 137, 21]),
                Y: U256::from_be_bytes([23, 81, 2, 77, 188, 45, 236, 116, 112, 97, 121, 7, 221, 241, 154, 125, 72, 96, 27, 134, 185, 55, 187, 225, 6, 85, 121, 193, 30, 89, 119, 135]),
            },
        ];
        Ok(VerifyingKey {
            alfa1,
